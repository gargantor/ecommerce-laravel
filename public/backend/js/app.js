...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    editAttributeValue: function editAttributeValue(value) {
      ...
      this.price = parseFloat(value.price);
    ...
    deleteAttributeValue: function deleteAttributeValue(value) {
      ...
      this.$swal({
        ...
        if (willDelete) {
          ...
          var _this = _this2;
          axios.post("/admin/attributes/delete-value", {
            id: _this.currentId
          }).then(function (response) {
...
module.exports = __webpack_require__(/*! /home/vagrant/Project_Laravel/ecommerce-application/resources/js/app.js */"./resources/js/app.js");
