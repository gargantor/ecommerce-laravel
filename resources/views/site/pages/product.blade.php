                            ...
                            <aside class="col-sm-7">
                                <article class="p-5">
                                    ...
                                    <dl class="row">
                                        ...
                                        <dt class="col-sm-9">{{ $product->sku }}</dt>
                                        <dt class="col-sm-3">Weight</dt>
                                        <dt class="col-sm-9">{{ $product->weight }}</dt>
                                    </dl>
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <dl class="dlist-inline">
                                                    <dt>Quantity:</dt>
                                                    <dd>
                                                    <input type="number" class="form-control" min="1" value="1" max="{{ $product->quantity }}" name="qty" style="width: 70px">
